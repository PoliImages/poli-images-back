...
// in poli_images_back/test/auth_service_test.dart.
...
import 'package:mongo_dart/src/auth/auth.dart' as _i9;
...
class MockDb extends _i1.Mock implements _i2.Db {
  ...
  _i2.State get state =>
      (super.noSuchMethod(
            ...
            returnValue: _FakeState_0(this, Invocation.getter(#state)),
          )
          as _i2.State);
  ...
  set databaseName(String? _databaseName) => super.noSuchMethod(
    Invocation.setter(#databaseName, _databaseName),
    returnValueForMissingStub: null,
  );

  @override
  set authSourceDb(_i2.Db? _authSourceDb) => super.noSuchMethod(
    Invocation.setter(#authSourceDb, _authSourceDb),
    returnValueForMissingStub: null,
  );

  @override
  set readPreference(_i3.ReadPreference? _readPreference) => super.noSuchMethod(
    Invocation.setter(#readPreference, _readPreference),
    returnValueForMissingStub: null,
  );
  ...
  void selectAuthenticationMechanism(String? authenticationSchemeName) =>
      super.noSuchMethod(
        Invocation.method(#selectAuthenticationMechanism, [
  ...
  _i2.DbCollection collection(String? collectionName) =>
      (super.noSuchMethod(
            Invocation.method(#collection, [collectionName]),
  ...
  _i7.Future<_i2.MongoReplyMessage> queryMessage(
    ...
    _i2.Connection? connection,
      ...
      (super.noSuchMethod(
            ...
            returnValue: _i7.Future<_i2.MongoReplyMessage>.value(
  ...
  @override
  _i7.Future<Map<String, dynamic>> executeModernMessage(
  ...
  _i7.Future<bool> dropCollection(String? collectionName) =>
      (super.noSuchMethod(
            Invocation.method(#dropCollection, [collectionName]),
            returnValue: _i7.Future<bool>.value(false),
          )
          as _i7.Future<bool>);

  @override
  _i7.Future<dynamic> drop() =>
      (super.noSuchMethod(
            Invocation.method(#drop, []),
            returnValue: _i7.Future<dynamic>.value(),
          )
          as _i7.Future<dynamic>);
  ...
  _i7.Future<Map<String, dynamic>> removeFromCollection(
    ...
    _i2.WriteConcern? writeConcern,
      ...
      (super.noSuchMethod(
            Invocation.method(#removeFromCollection, [
              collectionName,
              selector,
              writeConcern,
            ]),
  ...
  _i7.Future<Map<String, dynamic>> getLastError([
    _i2.WriteConcern? writeConcern,
      ...
      (super.noSuchMethod(
            Invocation.method(#getLastError, [writeConcern]),
            returnValue: _i7.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
            ),
          )
  ...
  @override
  _i7.Future<Map<String, dynamic>> wait() =>
      (super.noSuchMethod(
  ...
  @override
  _i7.Future<List<dynamic>> listDatabases() =>
      (super.noSuchMethod(
            Invocation.method(#listDatabases, []),
  ...
  @override
  _i7.Future<List<String?>> listCollections() =>
      (super.noSuchMethod(
  ...
  _i7.Future<List<Map<String, dynamic>>> getCollectionInfos([
    Map<String, dynamic>? filter = const {},
      ...
      (super.noSuchMethod(
            Invocation.method(#getCollectionInfos, [filter]),
  ...
  _i7.Future<List<String?>> getCollectionNames([
    Map<String, dynamic>? filter = const {},
      ...
      (super.noSuchMethod(
            Invocation.method(#getCollectionNames, [filter]),
            returnValue: _i7.Future<List<String?>>.value(<String?>[]),
          )
          as _i7.Future<List<String?>>);

  @override
  _i7.Future<bool> authenticateX509({_i2.Connection? connection}) =>
      (super.noSuchMethod(
            Invocation.method(#authenticateX509, [], {#connection: connection}),
            returnValue: _i7.Future<bool>.value(false),
          )
          as _i7.Future<bool>);
  ...
  _i7.Future<bool> authenticate(
    ...
    String? password, {
    _i2.Connection? connection,
    _i9.AuthenticationScheme? authScheme,
    String? authDb,
  }) =>
      (super.noSuchMethod(
            Invocation.method(
  ...
  _i7.Future<List<dynamic>> indexInformation([String? collectionName]) =>
      (super.noSuchMethod(
            Invocation.method(#indexInformation, [collectionName]),
            returnValue: _i7.Future<List<dynamic>>.value(<dynamic>[]),
          )
          as _i7.Future<List<dynamic>>);
  ...
  @override
  _i7.Future<Map<String, dynamic>> modernDropDatabase({
    _i10.DropDatabaseOptions? dropOptions,
    Map<String, Object>? rawOptions,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#modernDropDatabase, [], {
  ...
  @override
  _i7.Future<Map<String, dynamic>> serverStatus({
  ...
  @override
  _i7.Future<Map<String, dynamic>> createCollection(
    String? name, {
  ...
  _i7.Stream<Map<String, dynamic>> modernListCollections({
    ...
    Map<String, Object>? rawOptions,
      ...
      (super.noSuchMethod(
            Invocation.method(#modernListCollections, [], {
              #selector: selector,
              #filter: filter,
  ...
  @override
  _i7.Future<Map<String, dynamic>> createView(
    String? view,
    String? source,
  ...
  @override
  _i7.Future<Map<String, dynamic>> modernDrop(
    String? collectionNAme, {
  ...
  @override
  _i7.Future<Map<String, dynamic>> runCommand(Map<String, Object>? command) =>
      (super.noSuchMethod(
            Invocation.method(#runCommand, [command]),
            returnValue: _i7.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
            ),
          )
  ...
  @override
  _i7.Future<Map<String, dynamic>> pingCommand() =>
      (super.noSuchMethod(
            Invocation.method(#pingCommand, []),
            returnValue: _i7.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
            ),
          )
...
class MockDbCollection extends _i1.Mock implements _i2.DbCollection {
  ...
  _i2.Db get db =>
      (super.noSuchMethod(
            ...
            returnValue: _FakeDb_5(this, Invocation.getter(#db)),
          )
          as _i2.Db);
  ...
  _i7.Future<Map<String, dynamic>> save(
    ...
    _i2.WriteConcern? writeConcern,
      ...
      (super.noSuchMethod(
            Invocation.method(#save, [document], {#writeConcern: writeConcern}),
            returnValue: _i7.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
            ),
          )
  ...
  _i7.Stream<Map<String, dynamic>> find([dynamic selector]) =>
      (super.noSuchMethod(
            Invocation.method(#find, [selector]),
            returnValue: _i7.Stream<Map<String, dynamic>>.empty(),
          )
          as _i7.Stream<Map<String, dynamic>>);
  ...
  _i7.Stream<Map<String, dynamic>> legacyFind([dynamic selector]) =>
      (super.noSuchMethod(
            Invocation.method(#legacyFind, [selector]),
            returnValue: _i7.Stream<Map<String, dynamic>>.empty(),
          )
          as _i7.Stream<Map<String, dynamic>>);

  @override
  _i2.Cursor createCursor([dynamic selector]) =>
      (super.noSuchMethod(
            Invocation.method(#createCursor, [selector]),
  ...
  _i7.Future<Map<String, dynamic>?> findOne([dynamic selector]) =>
      (super.noSuchMethod(
            Invocation.method(#findOne, [selector]),
            returnValue: _i7.Future<Map<String, dynamic>?>.value(),
          )
          as _i7.Future<Map<String, dynamic>?>);
  ...
  _i7.Future<Map<String, dynamic>?> legacyFindOne([dynamic selector]) =>
      (super.noSuchMethod(
            Invocation.method(#legacyFindOne, [selector]),
            returnValue: _i7.Future<Map<String, dynamic>?>.value(),
          )
          as _i7.Future<Map<String, dynamic>?>);
  ...
  _i7.Future<Map<String, dynamic>?> findAndModify({
    ...
    bool? upsert,
      ...
      (super.noSuchMethod(
            Invocation.method(#findAndModify, [], {
              #query: query,
              #sort: sort,
              #remove: remove,
              #update: update,
  ...
  _i7.Future<Map<String, dynamic>?> legacyFindAndModify({
    ...
    bool? upsert,
      ...
      (super.noSuchMethod(
            Invocation.method(#legacyFindAndModify, [], {
              #query: query,
              #sort: sort,
              #remove: remove,
              #update: update,
  ...
  @override
  _i7.Future<int> count([dynamic selector]) =>
      (super.noSuchMethod(
            Invocation.method(#count, [selector]),
            returnValue: _i7.Future<int>.value(0),
          )
          as _i7.Future<int>);

  @override
  _i7.Future<int> legacyCount([dynamic selector]) =>
      (super.noSuchMethod(
            Invocation.method(#legacyCount, [selector]),
            returnValue: _i7.Future<int>.value(0),
          )
          as _i7.Future<int>);
  ...
  _i7.Future<Map<String, dynamic>> distinct(
    ...
    dynamic selector,
      ...
      (super.noSuchMethod(
            Invocation.method(#distinct, [field, selector]),
            returnValue: _i7.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
            ),
          )
  ...
  _i7.Future<Map<String, dynamic>> legacyDistinct(
    ...
    dynamic selector,
      ...
      (super.noSuchMethod(
            Invocation.method(#legacyDistinct, [field, selector]),
            returnValue: _i7.Future<Map<String, dynamic>>.value(
              <String, dynamic>{},
            ),
          )
  ...
  @override
  _i7.Future<List<Map<String, dynamic>>> getIndexes() =>
      (super.noSuchMethod(
            Invocation.method(#getIndexes, []),
            returnValue: _i7.Future<List<Map<String, dynamic>>>.value(
              <Map<String, dynamic>>[],
            ),
          )
  ...
  _i7.Future<_i3.WriteResult> insertOne(
    ...
    bool? bypassDocumentValidation,
      ...
      (super.noSuchMethod(
            ...
            returnValue: _i7.Future<_i3.WriteResult>.value(
              _FakeWriteResult_7(
                this,
                Invocation.method(
                  #insertOne,
  ...
  _i7.Future<_i3.BulkWriteResult> insertMany(
    ...
    bool? bypassDocumentValidation,
      ...
      (super.noSuchMethod(
            ...
            returnValue: _i7.Future<_i3.BulkWriteResult>.value(
  ...
  _i7.Future<_i3.FindAndModifyResult> modernFindAndModify({
    ...
    Map<String, Object>? rawOptions,
      ...
      (super.noSuchMethod(
            Invocation.method(#modernFindAndModify, [], {
              #query: query,
              #sort: sort,
              #remove: remove,
              #update: update,
  ...
  _i7.Future<Map<String, dynamic>?> modernFindOne({
    ...
    Map<String, Object>? rawOptions,
      ...
      (super.noSuchMethod(
            Invocation.method(#modernFindOne, [], {
              #selector: selector,
              #filter: filter,
              #sort: sort,
              #projection: projection,
  ...
  _i7.Future<_i4.DistinctResult> modernDistinct(
    ...
    Map<String, Object>? rawOptions,
      ...
      (super.noSuchMethod(
            ...
            returnValue: _i7.Future<_i4.DistinctResult>.value(
  ...
  @override
  _i7.Future<Map<String, dynamic>> modernDistinctMap(
    String? field, {
    dynamic query,
    _i15.DistinctOptions? distinctOptions,
    Map<String, Object>? rawOptions,
  ...
  @override
  _i7.Stream<_i16.ChangeEvent> watch(
    Object? pipeline, {
    int? batchSize,
    String? hint,
    Map<String, Object>? hintDocument,
    ...
    Map<String, Object>? rawOptions,
      ...
      (super.noSuchMethod(
            ...
            returnValue: _i7.Stream<_i16.ChangeEvent>.empty(),
          )
          as _i7.Stream<_i16.ChangeEvent>);
  ...
  _i7.Future<_i6.CountResult> modernCount({
    ...
    Map<String, Object>? rawOptions,
      ...
      (super.noSuchMethod(
            ...
            returnValue: _i7.Future<_i6.CountResult>.value(
              _FakeCountResult_12(
                this,
                Invocation.method(#modernCount, [], {
                  #selector: selector,
...
class MockWriteResult extends _i1.Mock implements _i3.WriteResult {
  ...
  int get writeErrorsNumber =>
      (super.noSuchMethod(Invocation.getter(#writeErrorsNumber), returnValue: 0)
          as int);
  ...
  @override
  set document(Map<String, dynamic>? _document) => super.noSuchMethod(
    Invocation.setter(#document, _document),
    returnValueForMissingStub: null,
  );

  @override
  set writeError(_i18.WriteError? _writeError) => super.noSuchMethod(
    Invocation.setter(#writeError, _writeError),
    returnValueForMissingStub: null,
  );

  @override
  List<Map<String, dynamic>> get serverResponses =>
      (super.noSuchMethod(
  ...
  @override
  int get nInserted =>
      (super.noSuchMethod(Invocation.getter(#nInserted), returnValue: 0)
          as int);

  @override
  int get nMatched =>
      (super.noSuchMethod(Invocation.getter(#nMatched), returnValue: 0) as int);

  @override
  int get nModified =>
      (super.noSuchMethod(Invocation.getter(#nModified), returnValue: 0)
          as int);

  @override
  int get nUpserted =>
      (super.noSuchMethod(Invocation.getter(#nUpserted), returnValue: 0)
          as int);

  @override
  int get nRemoved =>
      (super.noSuchMethod(Invocation.getter(#nRemoved), returnValue: 0) as int);

  @override
  int get totalInserted =>
      (super.noSuchMethod(Invocation.getter(#totalInserted), returnValue: 0)
          as int);

  @override
  bool get operationSucceeded =>
      (super.noSuchMethod(
  ...
  bool get taskCompleted =>
      (super.noSuchMethod(Invocation.getter(#taskCompleted), returnValue: false)
          as bool);
  ...
  @override
  bool get isPartial =>
      (super.noSuchMethod(Invocation.getter(#isPartial), returnValue: false)
          as bool);

  @override
  bool get isFailure =>
      (super.noSuchMethod(Invocation.getter(#isFailure), returnValue: false)
          as bool);

  @override
  set serverResponses(List<Map<String, dynamic>>? _serverResponses) =>
      super.noSuchMethod(
        Invocation.setter(#serverResponses, _serverResponses),
        returnValueForMissingStub: null,
      );
  ...
  set writeCommandType(_i19.WriteCommandType? _writeCommandType) =>
      super.noSuchMethod(
        Invocation.setter(#writeCommandType, _writeCommandType),
        returnValueForMissingStub: null,
      );

  @override
  set nInserted(int? _nInserted) => super.noSuchMethod(
    Invocation.setter(#nInserted, _nInserted),
    returnValueForMissingStub: null,
  );

  @override
  set nMatched(int? _nMatched) => super.noSuchMethod(
    Invocation.setter(#nMatched, _nMatched),
    returnValueForMissingStub: null,
  );

  @override
  set nModified(int? _nModified) => super.noSuchMethod(
    Invocation.setter(#nModified, _nModified),
    returnValueForMissingStub: null,
  );

  @override
  set nUpserted(int? _nUpserted) => super.noSuchMethod(
    Invocation.setter(#nUpserted, _nUpserted),
    returnValueForMissingStub: null,
  );

  @override
  set nRemoved(int? _nRemoved) => super.noSuchMethod(
    Invocation.setter(#nRemoved, _nRemoved),
    returnValueForMissingStub: null,
  );
  ...
  set writeConcernError(_i20.WriteConcernError? _writeConcernError) =>
      super.noSuchMethod(
        Invocation.setter(#writeConcernError, _writeConcernError),
        returnValueForMissingStub: null,
      );

  @override
  double get ok =>
      (super.noSuchMethod(Invocation.getter(#ok), returnValue: 0.0) as double);
  ...
  @override
  bool get failure =>
      (super.noSuchMethod(Invocation.getter(#failure), returnValue: false)
          as bool);

  @override
  set ok(double? _ok) => super.noSuchMethod(
    Invocation.setter(#ok, _ok),
    returnValueForMissingStub: null,
  );

  @override
  set errmsg(String? _errmsg) => super.noSuchMethod(
    Invocation.setter(#errmsg, _errmsg),
    returnValueForMissingStub: null,
  );

  @override
  set code(int? _code) => super.noSuchMethod(
    Invocation.setter(#code, _code),
    returnValueForMissingStub: null,
  );

  @override
  set codeName(String? _codeName) => super.noSuchMethod(
    Invocation.setter(#codeName, _codeName),
    returnValueForMissingStub: null,
  );
  ...
  bool checkQueryExpectation(int? expectedMatches) =>
      (super.noSuchMethod(
            Invocation.method(#checkQueryExpectation, [expectedMatches]),
            returnValue: false,
          )
          as bool);

  @override
  void extractBasic(Map<String, dynamic>? document) => super.noSuchMethod(
    Invocation.method(#extractBasic, [document]),
    returnValueForMissingStub: null,
  );
}
